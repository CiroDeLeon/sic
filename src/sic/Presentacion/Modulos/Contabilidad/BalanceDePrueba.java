 ...
 * @author Usuario1
 */
public class BalanceDePrueba extends javax.swing.JFrame implements sic.Presentacion.Suscripciones.ISuscripcion_BuscarSubcontabilidad{
    BalanceDePrueba_TableModel bp; 
    ContabilidadService cs;
    Subcontabilidad sub;
    BuscarSubcontabilidad bs;
    /**
     * Creates new form BalanceDePrueba
     */
    public BalanceDePrueba() {
        initComponents();        
        ...
        bp=new BalanceDePrueba_TableModel();
        this.jTable1.setModel(bp);
    ...
    public int getDigitos(){
        ...
        if(this.jComboBox6.getSelectedIndex()==3){
            return 8;
        }
        return 4;
    }
    public void Cargar(){
        ...
        boolean todos=this.jComboBox6.getSelectedIndex()==3;
        bp.setLista(cs.ObtenerBalanceDePrueba(fecha,fecha_final,n,sub,this.getDigitos(),todos));        
        this.jTable1.setModel(bp);
    }
    ...
    private void initComponents() {
        ...
        jLabel1.setText("BALANCE DE PRUEBA");
                ...
                .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    ...
                    .addGroup(layout.createSequentialGroup()
                        ...
                        .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING, false)
                            ...
                            .addComponent(dateChooserCombo1, javax.swing.GroupLayout.DEFAULT_SIZE, 83, Short.MAX_VALUE))
                        .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED)
                        .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                            .addGroup(layout.createSequentialGroup()
    ...
    private void jButton3ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton3ActionPerformed
        // TODO add your handling code here:        
        ReporteService.VerReporte("BalanceDePrueba.jasper",bp.getLista(),"Balance de Prueba");
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(BalanceDePrueba.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new BalanceDePrueba().setVisible(true);
            }
        });
    }
    ...
    public void setSubcontabilidad(Subcontabilidad subcontabilidad) {
        this.sub=subcontabilidad;
        if(sub!=null){
            this.jTextField1.setText(""+sub.getId());
            this.jTextField2.setText(""+sub.getDescripcion());
        }else{
