 ...
 * @author Usuario1
 */
public class MayorYBalance extends javax.swing.JFrame implements sic.Presentacion.Suscripciones.ISuscripcion_BuscarSubcontabilidad{
    ...
    private void initComponents() {
        ...
        jLabel1.setText("LIBRO MAYOR Y BALANCE");
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(MayorYBalance.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new MayorYBalance().setVisible(true);
            }
        });
    }
