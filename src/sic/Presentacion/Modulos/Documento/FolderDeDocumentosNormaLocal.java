 ...
 * @author FANNY BURGOS
 */
public class FolderDeDocumentosNormaLocal extends javax.swing.JFrame implements ISuscripcionBuscarUsuario,ISuscripcionBuscarEnAuxiliar,ISuscripcionBuscarFacturaDeUsuario,KeyListener,ISuscripcionAdministradorDeRegistrosCausables,sic.Presentacion.Suscripciones.ISuscripcion_BuscarSubcontabilidad,sic.Presentacion.Suscripciones.ISuscripcionBuscarCentroDeCosto{
    ...
    public FolderDeDocumentosNormaLocal() {
        initComponents();
    ...
    void BuscarCentroDeCosto(){
        if(this.subcontabilidad!=null){
           this.bcc=new sic.Presentacion.Modulos.EstructuraDeCostos.BuscarCentroDeCosto();
            ...
            .addGroup(jPanel4Layout.createSequentialGroup()
                ...
                .addGroup(jPanel4Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING, false)
                    .addGroup(jPanel4Layout.createSequentialGroup()
                        ...
                        .addGap(58, 58, 58)
                        .addGroup(jPanel4Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING, false)
                            .addComponent(jFormattedTextField2, javax.swing.GroupLayout.DEFAULT_SIZE, 344, Short.MAX_VALUE)
    ...
    public static void main(String args[]) {
        java.awt.EventQueue.invokeLater(new Runnable() {
            ...
            @Override
            public void run() {
                new FolderDeDocumentosNormaLocal().setVisible(true);
            }
        });
    }
    ...
    public void setSubcontabilidad(Subcontabilidad subcontabilidad) {
        ...
        if(this.subcontabilidad!=null){
           this.jTextField7.setText(""+this.subcontabilidad.getId());
           this.jTextField8.setText(""+this.subcontabilidad.getDescripcion());
        }else{
    ...
    public void setCentroDeCosto(CentroDeCosto obj) {
        ...
        if(obj!=null){
            ...
            this.jTextField11.setText("Ninguno");
