...
public class IngresarDocumentoNormaLocal extends javax.swing.JFrame implements ISuscripcionBuscarUsuario,ISuscripcionBuscarEnAuxiliar,ISuscripcionBuscarFacturaDeUsuario,ISuscripcionAdministradorDeRegistrosCausables,sic.Presentacion.Modulos.Documento.herramientas.YoUsoTrasladoMultiple,sic.Presentacion.Suscripciones.ISuscripcion_BuscarSubcontabilidad,sic.Presentacion.Suscripciones.ISuscripcionBuscarCentroDeCosto{
    Documento documento;   
    ...
    sic.Dominio.Core.EstructuraDeCostos.CentroDeCosto centro_de_costos;
    private boolean trabaja_subcontabilidad=false;
    /** Creates new form IngresarDocumento */
    public IngresarDocumentoNormaLocal() {
        initComponents();        
        this.jFormattedTextField13.setValue(new Long(0));
        this.jDialog1.pack();
        service=new DocumentoService();
        this.tiposdedocumentos=service.ObtenerTiposDeDocumentosContablesNormaLocal(); 
        this.CargarComboBox();
    ...
    void InicializarAsientoDelPanel(){
        ...
        a.setCentro_de_costos(centro_de_costos);
    }
            ...
            .addGroup(jPanel4Layout.createSequentialGroup()
                ...
                .addGroup(jPanel4Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING, false)
                    .addGroup(jPanel4Layout.createSequentialGroup()
                        ...
                        .addGap(66, 66, 66)
                        .addGroup(jPanel4Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING, false)
                            .addComponent(jFormattedTextField2, javax.swing.GroupLayout.DEFAULT_SIZE, 269, Short.MAX_VALUE)
                    ...
                    .addGroup(jPanel5Layout.createSequentialGroup()
                        ...
                        .addGroup(jPanel5Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.TRAILING)
                            ...
                            .addGroup(jPanel5Layout.createSequentialGroup()
                                ...
                                .addGroup(jPanel5Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                                    .addGroup(jPanel5Layout.createSequentialGroup()
                                        .addComponent(jFormattedTextField11, javax.swing.GroupLayout.PREFERRED_SIZE, 98, javax.swing.GroupLayout.PREFERRED_SIZE)
                                        .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED)
    ...
    private void jComboBox1KeyPressed(java.awt.event.KeyEvent evt) {//GEN-FIRST:event_jComboBox1KeyPressed
        // TODO add your handling code here:
        if(evt.getKeyCode()==evt.VK_ENTER){            
            if(this.trabaja_subcontabilidad){
    ...
    public static void main(String args[]) {
        java.awt.EventQueue.invokeLater(new Runnable() {
            ...
            @Override
            public void run() {
                new IngresarDocumentoNormaLocal().setVisible(true);
            }
        });
    }
    ...
    public void EventoDeSeleccionAuxiliar() {       
        if(ba.ObtenerAuxiliarSeleccionado().getId().toString().length()>8){
           ...
           if(ps.ObtenerCtaPuc(ba.ObtenerAuxiliarSeleccionado().getId().toString().substring(0,4))!=null && ps.ObtenerCtaPuc(ba.ObtenerAuxiliarSeleccionado().getId().toString().substring(0,6))!=null){ 
              ...
              boolean busca_centro_de_costo=cta.getId().toString().charAt(0)=='5' || cta.getId().toString().charAt(0)=='6' || cta.getId().toString().charAt(0)=='7';
              if(this.trabaja_subcontabilidad && busca_centro_de_costo){
                  this.BuscarCentroDeCosto();
              }
           }else{
    ...
    public void setAux_de_caja_para_balanceo_automatico(String aux_de_caja_para_balanceo_automatico) {
        ...
        this.trabaja_balanceo_automatico_con_caja=true;
    }
    ...
    public void setSubcontabilidad(Subcontabilidad subcontabilidad) {
        ...
        if(this.subcontabilidad!=null){
            this.jTextField11.setText(""+subcontabilidad.getId());
            this.jTextField12.setText(""+subcontabilidad.getDescripcion());
        }else{
    ...
    /**
     * @param trabaja_subcontabilidad the trabaja_subcontabilidad to set
     */
    public void setTrabaja_subcontabilidad(boolean trabaja_subcontabilidad) {
        this.trabaja_subcontabilidad = trabaja_subcontabilidad;
    }
}
