 ...
 * @author FANNY BURGOS
 */
public class FolderDeDocumentos extends javax.swing.JFrame implements ISuscripcionBuscarUsuario,ISuscripcionBuscarEnAuxiliar,ISuscripcionBuscarFacturaDeUsuario,KeyListener,ISuscripcionAdministradorDeRegistrosCausables,sic.Presentacion.Suscripciones.ISuscripcion_BuscarSubcontabilidad,sic.Presentacion.Suscripciones.ISuscripcionBuscarCentroDeCosto{
    ...
    public FolderDeDocumentos() {
        ...
        if(tiposdedocumentos.size()>0){
           int numeracion=service.getDao().ObtenerNumeracion(this.tiposdedocumentos.get(0).getDescripcion());
           this.Cargar(this.tiposdedocumentos.get(0).toString(),numeracion);
        }        
    }
    ...
    public void BuscarCentroDeCostos(){
            ...
            .addGroup(jPanel4Layout.createSequentialGroup()
                ...
                .addGroup(jPanel4Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING, false)
                    ...
                    .addGroup(jPanel4Layout.createSequentialGroup()
                        ...
                        .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED)
                        .addComponent(jTextField8, javax.swing.GroupLayout.DEFAULT_SIZE, 254, Short.MAX_VALUE)))
                .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED)
                .addGroup(jPanel4Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
